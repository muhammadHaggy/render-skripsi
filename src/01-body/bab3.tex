...
\begin{figure}[t!]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/pics/realisasi_fisik_iot.png}
...
\begin{figure}[t!]
    ...
    \includegraphics[width=0.5\textwidth]{assets/pics/rute_uji_validasi_fasilkom_felfest.jpeg}
